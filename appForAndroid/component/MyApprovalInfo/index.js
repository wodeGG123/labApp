...
export default class MyApprovalInfo extends Component {
  constructor(props){
    ...
    this.state = {
      AlertPromt:{
        modal:false,
        component:<AlertPromt buttonClick={(data)=>{this._check(1,data)}} />,
      },
  ...
  //
  // );
  let _AlertPromt = this.state.AlertPromt;
  _AlertPromt.modal = true;
    _AlertPromt.component = <AlertPromt title='备注' buttonClick={(data)=>{this._check(1,data)}} />;
  this.setState({
  ...
  let _AlertPromt = this.state.AlertPromt;
  _AlertPromt.modal = true;
  _AlertPromt.component = <AlertPromt title='备注' buttonClick={(data)=>{this._check(0,data)}} />;
  this.setState({
    AlertPromt:_AlertPromt
  })
  }
  render() {
    return ((this.state.type == 0)?<View style={styles.container}>
      ...
      {this.state.AlertPromt.modal?this.state.AlertPromt.component:null}
    </View>
    :
